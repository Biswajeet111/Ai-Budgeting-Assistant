...
FinAI is a premium, personal finance management tool built with **Streamlit** and powered by **Groq AI**. It combines traditional expense tracking with intelligent AI insights to help you master your finances.
...
- **🤖 AI Financial Coach**: A dedicated chatbot using Groq to provide personalized saving tips, investment advice, and budgeting strategies.
...
├── groq_chat.py          # Groq AI integration
